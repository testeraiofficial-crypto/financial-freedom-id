// CONFIG
const TOTAL_HUTANG = 275000; // (1) Saldo hutang menjadi 275.000
const ANGSURAN = 30000;      // (2) Angsuran menjadi 30.000
const START_DATE = new Date('2026-03-09'); // (3) Start 09 Maret 2026
